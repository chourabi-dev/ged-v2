...
export const MENU: MenuItem[] = [
    {
        id: 1,
        label: 'MENUITEMS.MENU_DOCUMENTS.TEXT',
        isTitle: true
    }, 
    {
        id: 2,
    ...
    {
        id: 4,
        label: 'MENUITEMS.ASSIGNED_DOCUMENTS.TEXT',
        icon: 'bx-file',
        link: '/dashboard/assigned-documents',
    },

    {
        id: 5,
        label: 'MENUITEMS.DOCUMENTS_AUDIT.TEXT',
        icon: 'bx-file',
        link: '/dashboard/documents-audit',
    },
    ...
    {
        id: 8,
        label: 'MENUITEMS.LOGIT_AUDIT.TEXT',
        icon: 'bx-file',
        link: '/dashboard/login-audits',
    },
    {
        id: 9,
        label: 'MENUITEMS.SERVEYS.TEXT',
        icon: 'bx-star',
    ...
    {
        id: 13,
        label: 'MENUITEMS.USERS_ROLES.TEXT',
        isTitle: true
    }, 
    {
        id: 14,
