...
@Component({
  selector: 'app-assigned-documents',
  templateUrl: './assigned-documents.component.html',
  styleUrls: ['./assigned-documents.component.scss']
})
export class AssignedDocumentsComponent {
